      ...
      <div className="max-w-4xl mx-auto">
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              The 5-1-1 rule is a guideline for when to contact your healthcare
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
              <p className="text-yellow-800">
                ...
                people may need to go to the hospital before reaching the 5-1-1
                pattern. Always follow your healthcare provider's specific
                instructions.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Check the table and charts to see your contraction patterns,
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Time between the start of one contraction and the start of the
                  next. Measured from peak to peak.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  ...
                  assess subjectively and discuss with your healthcare provider.
                </p>
              </div>
              <div>
