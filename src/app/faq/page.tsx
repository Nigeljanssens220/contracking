        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "How accurate should my timing be?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Don't worry about being perfectly precise to the second. Healthcare providers are looking for overall patterns rather than exact timing. Being within 10-15 seconds is generally accurate enough.",
                },
              },
              {
                "@type": "Question",
                name: "What if I miss timing a contraction?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "That's completely normal! You can add contractions manually using the Add Manual feature in the table. Just estimate the start and end times as best you can remember.",
                },
              },
              {
                "@type": "Question",
                name: "Should I time every single contraction?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "No, especially in early labor. Start timing when contractions become regular and uncomfortable. You can take breaks and resume timing when needed.",
                },
              },
              {
                "@type": "Question",
                name: "What's the difference between Braxton Hicks and real labor contractions?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Real labor contractions get stronger, longer, and closer together over time. They don't stop when you change positions or rest. Braxton Hicks are usually irregular and may stop with movement or rest.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes! All your contraction data is stored locally on your device only. Nothing is sent to servers or shared with anyone. Your privacy is completely protected.",
                },
              },
              {
                "@type": "Question",
                name: "Can I use this app offline?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes, the app works completely offline once it's loaded. This is especially important during labor when internet connectivity might be unreliable.",
                },
              },
            ],
          }),
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      Healthcare providers are looking for overall patterns
                      rather than exact timing. Being within 10-15 seconds is
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      That's completely normal! You can add contractions
                      manually using the "Add Manual" feature in the table. Just
                      estimate the start and end times as best you can remember.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      contractions become regular and uncomfortable. You can
                      take breaks and resume timing when needed.
                    </p>
                  </div>
              ...
              <section>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Yes, the app works completely offline once it's loaded.
                      This is especially important during labor when internet
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      provider can determine if you're in labor. The app helps
                      you collect data to share with them for better assessment.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      timing data. You can export the data or simply show them
                      the charts and statistics on your phone.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-red-50 border-l-4 border-red-500 p-6">
                  ...
                  <p className="text-red-700 mt-4 font-medium">
                    Don't wait to time contractions in emergency situations.
                    Trust your instincts and seek immediate medical attention.
                  </p>
                </div>
              </section>
            </div>
